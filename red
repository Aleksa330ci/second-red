...
<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="#"><img src="img/logo-final.svg" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item ">
                        <a class="nav-link header-nav-hover" href="#">главная </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">наши проекты</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">вакансии</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">партнёры</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">о нас</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">контакты</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header-nav-hover" href="#">рус</a>
                    </li>
                    <li class="nav-item">
                        <a href="#">
                            <button type="button" class="btn btn-danger button-all">Помочь</button>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Component%201%20–%201.svg" class="d-block w-100" alt="...">
                    <div class="carousel-block">
                        <h2>Депозиты и кредиты в повседневной жизни</h2>
                        <p>Фонд «RED» В феврале проводит уроки по финансовой грамотности со старшеклассниками Вроцловской школы.
...
<section class="help">
    <div class="container">
        ...
        <div class="row d-flex justify-content-around">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 section-help">
                <div class="post">
                <img src="img/Icon%20awesome-piggy-bank.svg" alt="">
                <h5>Информационная поддержка</h5>
                <p>Мы помогаем с поиском информации</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 section-help">
                <div class="post">
                <img src="img/Icon%20ionic-ios-hand.svg" alt="">
                <h5>Информационная поддержка</h5>
                <p>Мы помогаем с поиском информации</p>
                </div>
            </div>
...
<section class="section-fund">
    <div class="container">
        ...
        <a href="#">
            <button type="button" class="btn btn-danger button-all">Подробнее</button>
        </a>
    </div>
</section>
...
<div class="container">
    <div class="row section-volunteer-content">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <p>Leather and leather good exporters are gung-ho about hitting $5 billion in export receipts by 2022 if the government manages the Leather Working Group’s certification at the earliest, according to industry insiders. Last fiscal year, leather and leather good exports fetched $1.19 billion,
                making it the second highest export earner for Bangladesh after garment, according t</p>
            <a href="#">
                <button type="button" class="btn btn-danger button-all">Join Us Now</button>
            </a>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-6 col-lg-9">
            <h3>Our Executive</h3>
            <h4>Expert Team</h4>
            <p>Leather and leather good exporters are gung-ho about hitting $5 billion in export <br>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12"> <img src="img/lucas-sankey-9R-CH7PR150-unsplash.png" alt="" class="img-fluid">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12"> <img src="img/benjamin-parker-OhKElOkQ3RE-unsplash.png" alt="" class="img-fluid">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12"> <img src="img/adult-beautiful-digital-nomad-1181496.png" alt="" class="img-fluid">
            <div class="card-body">
